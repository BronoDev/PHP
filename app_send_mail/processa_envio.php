...
try {
	...
	$mail->AltBody = 'É necessário utilizar um client que suporte HTML para ter acesso total ao centeúdo da mensagem';

	$mail->send();

	$mensagem->status['codigo_status'] = 1;
	$mensagem->status['descrocao_status'] = 'E-mail enviado com sucesso';
} catch (Exception $e) {
